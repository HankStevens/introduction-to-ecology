...
#| label: fig-dag1
#| layout-ncol: 1
#| fig-cap: "The simplest causal graph or DAG, in which soil moisture (M) affects plant growth (G)."
#| echo: false
#| message: false
#| out-width: "80%" 
library(ggraph)
...
#| label: fig-dag2
#| layout-ncol: 1
#| fig-cap: "A more complicated causal graph (DAG), showing only an indirect effect of rain  on growth, and two variables each having a direct effect on growth."
#| echo: false
#| message: false
#| out-width: "80%" 
coords <- list(
...
ggsave("figs/my_scatterplot_trees.png", width=5, height=5)
```
