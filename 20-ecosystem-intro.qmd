...
1. Why do we have this much carbon in the atmosphere?
...
1. build a simple ecosystem budget with steady fluxes and changing pools,
...
One of the main the points of doing these activities is to help to develop an intuition for *systems thinking*. A system is "[a group of interacting, interdependent parts that form a complex whole"](https://en.wikipedia.org/wiki/Systems_theory){target="_blank"} and ecosystem ecology is a central subdisicpline of ecology and the one that has contributed the most to our understanding of climate change and ecosystem services.
...
1. General background lectures: [Download and watch the video on the carbon cycle](https://drive.google.com/drive/folders/1nWLoEGuWKIWdul9Uvse5qiB1Hf8MCwUv?usp=sharing){target="_blank"} before proceeding.
1. We will not need data for this chapter.
1. This chapter will ask you to complete some work by hand (without R) and turn that in in class. Find out what you need for the deliverables parts 1 (@sec-deliverables-ei1) and 2 (@sec-deliverables-ei2).
...
1. with code such as this, in which you must customize it to your computer!
```
...
Here we have outputs from the atmosphere mostly into plants on land and into the oceans where most of it is taken up by phytoplankton, kelp, seagrasses, and corals. A small amount of it remains in the water and makes it more acidic.
```{r}
...
The difference between inputs and outputs is *net flux*:
```{r}
net.flux <- inputs - outputs
net.flux # in Pg C per year
```

At that time, Earth had a pool of carbon in the atmosphere of about 762 Pg C.
```{r}
# the pool
At <- 762
```

So, what would it have one year later? It would have the pool plus the net flux.
```{r}
...
## Deliverables, part 1 {#sec-deliverables-ei1}
...
## Deliverables, part 2 {#sec-deliverables-ei2}
