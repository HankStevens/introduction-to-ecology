---
title: "Community Ecology: Why are there so many tree species, and where?"
---
...
@Manual{oksanen2022, title  = {vegan: Community Ecology Package}, author = {Oksanen, Jari and others}, year   = {2022}, note   = {R package version 2.6} }
-->

::: {.callout-note appearance="simple"}
This chapter cites @davies2021, @anderson-teixeira2015, @condit1996, @kenfack2007, @hillebrand2004, @gotelli2001, and the `vegan` package [@oksanen2022]. Full references appear in the book's reference list once these keys are in your `.bib`.
:::
