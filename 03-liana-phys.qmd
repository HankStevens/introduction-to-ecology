...
1. Two graphs done in R that use data to evaluate the hypothesis of Smith-Martin and her colleagues. The variables in the graphs must match the variables in your predictions.
...
- Loading any packages you need, such as `ggplot2`, or others.
