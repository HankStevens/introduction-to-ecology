...
1. Upload three files to the Canvas First R Script assignment:
   a. `myPlot.png`
   a. `myDataframe.csv`
   a. the R script, into which you wrote all your code. This file must be written in RStudio, and the name must end with the file name extension, ".R", such as "Hanks_script.R"
