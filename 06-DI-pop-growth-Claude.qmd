...
* Read Cohen (1995) in Perusall through our Canvas site. It is also available in our class archive: [Cohen (1995)](https://drive.google.com/drive/folders/1opLlrmF7kfo0FtWwwJ1CbfPWIyuaISC1?usp=sharing)
...
@eq-Ntproj is not a separate fact to memorize --- it is a *logical consequence* of @eq-r. If you accept that the per capita growth rate $r$ is constant (our assumption), then the projection equation *must* follow. The math does not add new biology; it reveals what our assumptions already imply.

This is what mathematical reasoning does in ecology: it shows you the consequences you have already committed to when you stated your assumptions. If you change the assumptions --- say, by letting $r$ vary with population size --- the projection equation changes too. The derivation tells you *why* the equation has the form it does, which means you can adapt it when the biology demands something different. Mathematical reasoning is a form of ecological understanding: following this derivation *is* one of the ways you come to understand how populations grow.
:::
...
1. How many people were alive when you were born? How many people will there be at the end of your lifetime? Are you going to live through a doubling of the human population? Why or why not?
