...
![The loggerhead sea turtle is listed as "vulnerable" by the IUCN 3.1. image: By ukanda - originally posted to Flickr as Loggerhead turtle, CC BY 2.0, https://commons.wikimedia.org/w/index.php?curid=10481668](figs/caretta.jpg){#fig-caretta}
...
- Read Crouse et al. (1987) in Perusall through our Canvas site. It is also available in our class archive: [Cohen (1995)](https://drive.google.com/drive/folders/1opLlrmF7kfo0FtWwwJ1CbfPWIyuaISC1?usp=sharing)
...
- If you are curious, check Deliverables, at the end (@sec-deliverables-spg).
...
b.  Which stages have the highest annual survivorship?
...
1.  Compare Table 3 and Table 4 (above). What are the relationships between survival and fecundity in Table 3, and the diagonal (stasis) and off-diagonal elements (growth) of the matrix in Table 4? How are they related?
2.  Why do you think that the diagonal matrix elements (Table 4) not the same are the annual survivorship in Table 3?
...
As we try to understand and appreciate the meaning of sea turtle life history, demography, and survival, we will focus on three characteristics:
...
Lambda, $\lambda$, is the long term *finite rate of increase*.

- It assumes density-independent growth.
- It is a long term prediction which assumes the *population structure* will be constant.
- It is the proportional change in the size of the population from one year to the next.
...
2.  Change the new matrix to include survivorship of 0.999 for the hatchlings (see below!).
3.  Calculate lambda for the new matrix (see below).
...
## Deliverables {#sec-deliverables-spg}
...
2.  A table similar to Table 7.1 with all the stages, the provided values of stasis, and growth, and your new values of lambda.
3.  Assume you want to maximize long-term population growth rate ($\lambda$). For which stage or stages should you invest in protection measures? Explain why, and use your values of lambda as evidence in your answer.
