...
1. Why do you think that the diagonal matrix elements (Table 4) not the same are the annual survivorship in Table 3?
...
1. Assume you want to maximize long-term population growth rate ($\lambda$). For which stage or stages should you invest in protection measures? Explain why, and use your values of lambda as evidence in your answer.
