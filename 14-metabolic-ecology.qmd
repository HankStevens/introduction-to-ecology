...
![The data we use in this chapter were collected from gizzard shad at three man-made lakes (reservoirs) in Ohio, U.S.A.[@higgins2006dsn; @schaus1997npe](figs/reservoirs.png){#fig-res}
...
### Temperature dependence, the Arrhanius Equation, and $Q_{10}$
...
In the late 1800s, Svante Arrhenius described the power law relation for the temperature dependence of chemical reaction rates; you may have encountered this in your chemistry class. This was quantified from first principles by Ludwig Boltzmann[^Boltzmann's work on this and on *entropy* have connections throughout science, including Plank's constant, blackbody radiation, and even the meaning of time.], who showed how the emergent property we call temperature emerges from the thermal energy of individual molecules. You will encounter Boltzmann's constant in our last chapter, on global heating.

Another way to describe temperature sensitivity is **$Q_{10}$**: the multiplication factor by which a rate increases when temperature rises by 10°C. If an organism's excretion rate *doubles* when temperature goes from 15°C to 25°C, then $Q_{10} = 2$. Most $Q_{10}$ values for biological rates fall between 1.5 and 3.
...
This kind of mathematical reasoning---working through *why* the formula has the structure it does---is exactly the skill that lets you check whether a calculation makes sense. Anyone (or any AI) can plug numbers into a formula. Understanding *why* the formula works is what builds connections among neurons in your brain ... aad lets you catch mistakes.
:::
