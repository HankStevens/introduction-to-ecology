...
Two R skills recur across nearly every chapter: wrangling data with **tidyverse**-style functions (things like `read_csv`, `subset`, `mutate`), and visualizing it with **`ggplot2`**. You will practice these so often that, by the end of the book, they should feel like second nature. If you ever want help translating that practice into language for a résumé, cover letter, or job application, see the *Skills Crosswalk* appendix near the end of the book.
